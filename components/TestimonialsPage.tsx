...
const allTestimonials: TestimonialItem[] = [
  ...
  },
  {
    ...
    role: 'הילה | בעלים',
    content: 'הפרסום עובד, אבל הערך האמיתי הוא הבהירות. עלמה? עוזרים לדייק את המסר, להבין מה נכון לקדם ואיפה לשים את הכסף. זה משנה את כל ההתנהלות.',
    image: 'https://picsum.photos/100/100?random=24'
  },
  {
    id: '5',
    name: 'עמותת צער בעלי חיים בישראל',
    role: 'הילמה | יו"ר',
    content: 'העבודה עם עלמה? נותנת לנו ליווי אמיתי, לא רק קמפיינים. יש חשיבה אסטרטגית, רגישות לארגון ושקיפות מלאה, גם בסביבה מורכבת.',
  ...
  },
  {
    ...
    name: 'אייזן',
    role: "אמג'ד | בעלים",
    content: 'העבודה עם עלמה? היא תהליך מתמשך, לא פעולה נקודתית. אסטרטגיה, פרסום, מועדון חברים וליווי שוטף מתחברים למנגנון אחד שעובד בלי אלתורים.',
