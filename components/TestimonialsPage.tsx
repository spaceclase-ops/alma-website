...
const allTestimonials: TestimonialItem[] = [
  ...
  },
  {
    ...
    role: 'מאיה | יו"ר',
    content: 'ההיכרות שלנו עם ניב מ"עלמה?" היא בת כמה שנים ורק משתבחת עם הזמן. מהרגע הראשון התרשמנו מאיש אמין, מקצועי, רגיש לצרכי הלקוח ומאד מתחשב. תמיד יודע להתאים את הלך המחשבה שלו לזה שלנו ולראות דרכנו במה להתרכז ואיך לקדם אותנו. נגיש בכל עת ובכל מצב ובאמת מעניק שירות איכותי והזדהות מלאה עם המטרה לשמה פנינו אליו. אין עליו, מנסיון...',
    image: '/images/החתולים בישראל עמותת.png'
  }
];
          ...
          {allTestimonials.map((item) => (
            ...
            >
              ...
              <div className="flex items-center gap-4 mb-8">
                <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-alma-light shadow-md bg-white">
